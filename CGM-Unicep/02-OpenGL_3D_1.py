...
def principal():
        ...
        glTranslatef(.5, 1, -5) #Afastando-se do objeto para poder vizualiza-lo
        glRotatef(30,1,0,0) #Girando um pouco a tela para enxergar melhor os cubos (Eixo X)
        glRotatef(30,0,1,0) #Girando um pouco a tela para enxergar melhor os cubos (Eixo Y)
